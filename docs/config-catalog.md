...
- `@deepseek-ai/dsh-host-auto-mode-admission` — requires `settings` ([`packages/host/auto-mode-admission/src/index.ts`](../packages/host/auto-mode-admission/src/index.ts))
