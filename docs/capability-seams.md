...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.dshAutoModeAdmission` | `core` | `auto-mode-admission` | - | [`api-remotes`](../packages/api/remotes) | - | Persists user admission and exposes a bounded external-plugin projection; the external plugin owns evidence and routing. |
