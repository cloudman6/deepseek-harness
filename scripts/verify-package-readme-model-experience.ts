...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-auto-mode': { kind: 'indirect', reason: 'Browser-side admission controls affect only later external Auto route choices.' },
  ...
  'packages/host/auto-mode-admission': { kind: 'indirect', reason: 'The Settings bridge constrains only later external Auto route choices.' },
