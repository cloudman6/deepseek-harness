...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  dshAutoModeAdmission: 'settings.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionEventNamespaceRegistration: 'session.md',
  SessionId: 'core.md',
  ...
  RouteAdmissionMode: 'settings.md',
  RouteAdmissionProjection: 'settings.md',
  RouteAdmissionProjectionProvider: 'settings.md',
  RouteAdmissionSettings: 'settings.md',
  RouteAdmissionView: 'settings.md',
