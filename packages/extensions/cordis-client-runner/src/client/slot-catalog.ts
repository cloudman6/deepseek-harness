...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, auto-route-change, command, command-input, compaction, context, manual-compaction, model-retry, steering, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      ...
      'client-ui-model-selection AutoRouteChangeNodeView key \'auto-route-change\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-auto-mode AutoModeSettingsSection id \'auto-mode\'',
