...
export const zh = {
  ...
  'menu.autoSnapshot': 'AA 快照：{snapshot}',
  'menu.autoSnapshotUnavailable': 'AA 快照：不可用（旧版决策）',
  'menu.autoSnapshotNotApplicable': 'AA 快照：不适用（配置的 fallback）',
...
export const en = {
  ...
  'menu.autoSnapshot': 'AA snapshot: {snapshot}',
  'menu.autoSnapshotUnavailable': 'AA snapshot: unavailable (legacy decision)',
  'menu.autoSnapshotNotApplicable': 'AA snapshot: not applicable (configured fallback)',
