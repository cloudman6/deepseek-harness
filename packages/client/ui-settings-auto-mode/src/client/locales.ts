...
export const zh = {
  ...
  recommended: 'Recommended', recommendedHelp: '启用当前环境中所有可调用、策略合格且精确绑定的路线。',
  custom: 'Custom', customHelp: '从 Recommended 集合开始，只限制 Auto 可用候选；不会修改证据 binding。',
  ...
  coverage: '当前候选', routes: '条路线', bindings: '条 binding', exclusions: '条排除记录',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  recommended: 'Recommended', recommendedHelp: 'Enable every callable, policy-eligible, exact-bound route in the current environment.',
  custom: 'Custom', customHelp: 'Start from Recommended and restrict Auto candidates only; evidence bindings are unchanged.',
  ...
  coverage: 'Current candidates', routes: 'routes', bindings: 'bindings', exclusions: 'exclusions',
