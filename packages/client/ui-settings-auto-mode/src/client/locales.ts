...
export const zh = {
  ...
  custom: 'Custom', customHelp: '首次启用时从当前 Recommended 集合开始；之后切换模式会保留已保存的 Custom 选择，包括空集合。仍可增减任意当前可调用且精确绑定的路线；不会修改证据 binding。',
  ...
  packBindingTag: 'Pack binding', automaticBindingTag: '自动精确匹配',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  custom: 'Custom', customHelp: 'The first use starts from Recommended. Later mode switches preserve the saved Custom selection, including an empty set. Add or remove any current callable exact-bound route; evidence bindings are unchanged.',
  ...
  packBindingTag: 'Pack binding', automaticBindingTag: 'Automatic exact match',
