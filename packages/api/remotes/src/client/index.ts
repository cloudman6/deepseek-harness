...
import autoModeAdmissionRemote from '@deepseek-ai/dsh-host-auto-mode-admission/remote'
...
export type {} from '@deepseek-ai/dsh-host-auto-mode-admission/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, autoModeAdmissionRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
